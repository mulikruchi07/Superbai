...
class _MobileNumberScreenState extends State<MobileNumberScreen>
  ...
  final List<Map<String, String>> _onboardingPages = [
    {
      ...
      'title': 'WELCOME',
      'subtitle':
          '\"Experience Effortless Cleanliness at\nYour Fingertips with Our Trusted App.\"',
    },
    {
  ...
  bool _showOtpInfoLine =
      false; // Controls visibility of "OTP send to the Number" line
  ...
  void initState() {
    ...
    _onboardingTimer = Timer.periodic(const Duration(seconds: 2), (
      Timer timer,
    ) {
      if (!mounted) {
        timer.cancel();
  ...
  void _requestOtp() {
    ...
    if (_mobileNumberController.text.length == 10) {
      setState(() {
        _maskedMobileNumber =
            '+91 | ${_mobileNumberController.text.substring(0, 5)} ***** ${(_mobileNumberController.text.length > 9) ? _mobileNumberController.text.substring(8, 10) : ''}';
            ...
            child: ConstrainedBox(
              ...
              constraints: BoxConstraints(
                minHeight:
                    ...
                    MediaQuery.of(
                      context,
                    ).viewInsets.bottom, // Adjust minHeight for keyboard
              ),
              child: Column(
                mainAxisAlignment:
                ...
                children: [
                  ...
                  Column(
                    children: [
                      ...
                      SizedBox(
                        // Fixed height for image area for consistency
                        height:
                            constraints.maxHeight *
                            0.4, // Responsive height based on available space
  ...
  Widget _buildMobileInputContent() {
    return Padding(
      // Added Padding inside this method for consistency
        ...
        children: [
          ...
          TextField(
            ...
            decoration: InputDecoration(
              ...
              filled: true,
              fillColor:
                  AppColors.neutralWhite, // Inner fill color for text field
    ...
    return Padding(
      ...
      child: Column(
        ...
        children: [
            ...
            children: List.generate(4, (index) {
              return SizedBox(
                ...
                child: TextField(
                  ...
                  keyboardType:
                      TextInputType.number, // Use native number keyboard
                  textAlign: TextAlign.center,
                  maxLength: 1,
                  style: GoogleFonts.poppins(
                    color: AppColors.neutralBlack,
                    fontSize: AppTextStyles.heading3.fontSize,
                  ), // Poppins for OTP input text
                  decoration: InputDecoration(
                    counterText: "",
                    filled: true,
                    fillColor:
                        AppColors.neutralWhite, // OTP boxes inner fill color
                    border: OutlineInputBorder(
                      borderRadius: BorderRadius.circular(12.0),
                      borderSide: BorderSide.none,
                    ),
          ...
          if (_showOtpInfoLine &&
              _maskedMobileNumber.isNotEmpty) // Conditionally display
            Padding(
              padding: const EdgeInsets.only(
                top: 10.0,
              ), // Space above this text
              child: Row(
                // Changed to Row to put text and change number on same line
                mainAxisAlignment:
                    MainAxisAlignment.spaceBetween, // Space out horizontally
                children: [
                  Column(
                    // Use Column to stack "OTP send to the Number" and the masked number
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      Text(
                  ...
                  GestureDetector(
                    onTap: () {
                      setState(() {
                        ...
                        _maskedMobileNumber =
                            ''; // Clear masked number when changing back
                        _showOtpInfoLine =
                            false; // Hide info line on return to mobile input
                      });
                      FocusScope.of(
                        context,
