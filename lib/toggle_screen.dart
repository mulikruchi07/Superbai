...
class _ToggleScreenState extends State<ToggleScreen> {
  String? _selectedOption; // Stores the currently selected option: 'yes' or 'no'
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: FittedBox( // Use FittedBox to ensure text fits horizontally
          fit: BoxFit.scaleDown, // Scale down text if it's too large
          alignment: Alignment.centerLeft, // Align left within the FittedBox
          child: Column( // Use a Column to stack the title and question
            crossAxisAlignment: CrossAxisAlignment.start,
            children: [
              Text(
                'Hello Ankit,',
                style: GoogleFonts.poppins( // Poppins for 'Hello Ankit,'
              ...
              Text(
                ...
                style: GoogleFonts.poppins( // Poppins for 'Do you already have Maid?'
                  fontSize: 16, // Reduced font size for header
                  color: AppColors.neutralWhite,
                  fontWeight: FontWeight.w500, // Poppins Medium or SemiBold
                ),
      ...
      body: LayoutBuilder( // Use LayoutBuilder to get available screen height
        builder: (context, constraints) {
          ...
          final double illustrationHeight = screenHeight * 0.45; // Increased height to reduce gap further

          return Column(
            mainAxisAlignment: MainAxisAlignment.spaceBetween, // Distribute space
            children: [
              Column( // This column holds all content above the illustration
                children: [
                  ...
                  const SizedBox(height: 30), // Spacing between options and info card

                  // Informational Card (conditionally displayed)
                  if (_selectedOption != null) // Only show when an option is selected
                    Padding(
                      padding: const EdgeInsets.symmetric(horizontal: 20.0), // Apply horizontal padding here
                      child: AnimatedOpacity(
                        ...
                        child: Container(
                          ...
                          decoration: BoxDecoration(
                            ...
                            borderRadius: BorderRadius.circular(20), // Curved edges for the card
                            border: Border.all(
                              color: AppColors.neutralLightGray, // Thin grey outline
                          ...
                          child: Column(
                            children: [
                              Text(
                                ...
                                _selectedOption == 'yes' ? 'Congratulations!' : 'No maid, no worries!',
                                style: GoogleFonts.poppins( // Poppins Bold for info card title
                              ...
                              Text(
                                _selectedOption == 'yes'
                                    ? 'You\'re already a master of household harmony. Let us help you maintain that peace effortlessly with our maid management services'
                                    : 'Discover a world of trustworthy and verified maids at your fingertips. Your search for the perfect helping hand starts here.',
                                style: GoogleFonts.poppins( // Poppins Regular for info card subtitle
                              ...
                              SizedBox(
                                ...
                                child: ElevatedButton(
                                  onPressed: () {
                                    if (_selectedOption == 'yes') { // 'Yes' implies "Manage/Onboard your current Maid" contextually
                                      // Navigate to FindMaidScreen for 'Yes'
                                      Navigator.of(context).push(
                                        MaterialPageRoute(
                                          builder: (context) => const FindMaidScreen(), // Corrected name
                                        ),
                                      );
                                    } else if (_selectedOption == 'no') { // 'No' implies "Looking for a Maid"
                                  ...
                                  style: ElevatedButton.styleFrom(
                                    ...
                                    shape: RoundedRectangleBorder(
                                      borderRadius: BorderRadius.circular(25.0), // More curved edges for buttons
                                    ),
                                  ),
                                  child: Text(
                                    'CONTINUE',
              ...
              Image.asset(
                ...
                fit: BoxFit.cover, // Use BoxFit.cover to fill the space without leaving white
  ...
  Widget _buildToggleOption({
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          color: isSelected ? AppColors.primaryPurple : AppColors.neutralWhite, // Transparent grey for deselected
          borderRadius: BorderRadius.circular(15), // Rounded corners for option boxes
          border: Border.all(
            color: isSelected ? AppColors.primaryPurple : AppColors.neutralLightGray, // Grey border for deselected
        ...
        child: Column(
          ...
          children: [
            Text(
              title,
              style: GoogleFonts.poppins( // Poppins Medium or SemiBold for button text
                fontSize: AppTextStyles.heading4.fontSize,
            ...
            Text(
              ...
              style: GoogleFonts.poppins( // Poppins Regular for subtext
                fontSize: AppTextStyles.bodyText.fontSize,
                color: isSelected ? AppColors.neutralWhite.withOpacity(0.8) : AppColors.neutralDarkGray,
                fontWeight: FontWeight.normal,
              ),
            ),
          ],
